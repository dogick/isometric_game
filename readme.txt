If you downloaded this from a URL somewhere on the internet (including
the blog at trederia) then you do not have the latest version. This project
has been moved to https://github.com/fallahn/sfml-tmxloader where you
can always find the latest version, and even contribute to it.

This download has been left here to prevent any broken links, and point
potential users in the right direction.
